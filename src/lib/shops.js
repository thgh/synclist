const shops = [{
    ...
    key: '5',
    name: 'random',
    entities: 'microfiber vod,pompoenpitten,zoete aardappel,vetbollen,vaatblokjes,vaatwasblokjes,balsamico'
  }, {
    shop: 'Colruyt Ledeberg',
    key: '6',
    name: 'vriezer',
    ...
    key: '4.2',
    name: 'kaas',
    entities: 'geitenkaas,heksenkaas,haloumi,griekse yoghurt,kaasblokjes,mozarella,mozzarella,mozarella bolletjes,parmezaan,raclette'
  }, {
    shop: 'Colruyt Ledeberg',
    key: '4.3',
    name: 'fruit',
...
shops.forEach(shop => {
    if (typeof shop.entities === 'string') {
      shop.entities = shop.entities.split(',').map(s => s.trim()).filter(Boolean)
    }
